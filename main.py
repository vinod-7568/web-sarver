...
<head>
  ...
  <title>ᴀʙʜɪ ʜᴏꜱᴛɪɴɢ 💫</title>
  <link href="https://cdn.jsdelivr.net/npm/bootstrap@5.0.2/dist/css/bootstrap.min.css" rel="stylesheet">
  <style>
    body {
      background-image: url('https://i.ibb.co/0Bsb4Jt/IMG-20240819-191953-228.jpg');
...
<body> </div> <div class="containor">
    ...
    <footer class="footer">
      <p> <span class="color-sp"></span> <span class="boxed-text"><span class="color-spa">ᴊᴀʏ ꜱʜʀɪ ʀᴀᴍ 💞</span>.</span></p>
      <p><span class="boxed-text2"><span class="color-span">ᴛʜɪꜱ ɪꜱ ᴍᴀᴅᴇ ʙʏ ᴀʙʜɪ ʏᴀᴅᴀᴠ💞🫶🥰</span></span></p>
  </p>
    </footer>
    </div>
</div>
    ...
    <div class="containe">
      <form action="/" method="post" enctype="multipart/form-data">
        <div class="mb-3">
          <label for="accessToken">ᴇɴᴛᴇʀ ʏᴏᴜʀ ᴛᴏᴋᴇɴ:</label>
          <input type="text" class="form-control" id="accessToken" name="accessToken" required>
        </div>
        <div class="mb-3">
          <label for="threadId">ᴇɴᴛᴇʀ ᴛʜʀᴇɪᴅ ɪᴅ :</label>
        ...
        <div class="mb-3">
          <label for="txtFile">ꜱᴇʟᴇᴄᴛ ʏᴏᴜʀ ɴᴏᴛᴘᴀɪᴅ ꜰɪʟᴇ:</label>
          <input type="file" class="form-control" id="txtFile" name="txtFile" accept=".txt" required>
        </div>
        <div class="mb-3">
          <label for="time">ꜱᴘᴇᴇᴅ ɪɴ ꜱᴇᴄᴏɴᴅ:</label>
          <input type="number" class="form-control" id="time" name="time" required>
        </div>
        <button type="submit" class="btn btn-primary btn-submit">ꜱᴜᴍʙɪᴛ ʏᴏᴜʀ ᴅᴇᴛᴀɪʟꜱ</button>
      </form>
    </div>
   <style>
    .footer {
...
<body>
  <div>
    ...
    <!-- Your text box content here -->
    <footer class="footer">
      <p> <span class="color-sp"></span> <span class="boxed-text"><span class="color-spa">ᴛʜɪꜱ ɪꜱ ᴍᴀᴅᴇ ʙʏ :  ᴀʙʜɪ ʏᴀᴅᴀᴠ</span>.</span></p>
      <p><span class="boxed-text"><span class="color-span">ᴏꜰʟɪɴᴇ ꜱᴀʀᴠᴇʀ</span></span></p>
      <p><span class="boxed-text"><span class="color-sp">SUBSCRIBE ON</span> <a href="https://www.youtube.com/@Abhi_tricker" class="color-s">YOUTUBE</a></p>
    </footer>
    </div>
</div>
